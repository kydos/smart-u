...
/**
* vortex/demo/smartu/IndexHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ../idl/smartu.idl
* Tuesday, November 4, 2014 9:49:18 PM CET
*/

abstract public class IndexHelper
{
  private static String  _id = "IDL:vortex/demo/smartu/Index:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (vortex.demo.smartu.IndexHelper.id (), "Index", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    vortex.demo.smartu.Index value = new vortex.demo.smartu.Index ();
